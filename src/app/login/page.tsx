        ...
        {otpSent ? (
          <Card className="w-full mx-auto">
            <CardHeader>
              ...
              <CardDescription>We&apos;ve sent a 4-digit code to your phone number.</CardDescription>
            </CardHeader>
            <CardContent className="flex justify-center">
              <InputOTP maxLength={4} value={enteredOtp} onChange={handleOtpChange}>
                <InputOTPGroup>
          ...
          <Card className="w-full mx-auto">
            ...
            <CardContent>
              <form>
                <div>
                  <Label className="font-semibold text-muted-foreground text-xs" htmlFor="name">
                    Name
                  </Label>
                  <Input id="name" placeholder="Enter your name" value={name} onChange={(e) => setName(e.target.value)} />
                </div>
                <div>
                  <Label className="font-semibold text-muted-foreground text-xs" htmlFor="phone">
                    Phone Number
                  </Label>
                  <div className="flex">
